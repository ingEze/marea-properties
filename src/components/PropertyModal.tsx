...
export default function ValuationSection() {
  ...
  return (
    <>
      <section
        id="valuation"
        className="bg-forest px-4 py-16 sm:px-6 sm:py-20 lg:px-10 lg:py-24"
      >
        <div className="mx-auto max-w-7xl">
          <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/[0.035] px-6 py-8 sm:px-10 sm:py-12 lg:px-14 lg:py-14">
            ...
            <div className="relative flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
              ...
              <button
                type="button"
                onClick={openModal}
                className="group inline-flex h-12 w-full shrink-0 items-center justify-center gap-2 rounded-lg bg-white px-6 text-sm font-medium text-forest transition hover:bg-white/90 focus:outline-none focus:ring-2 focus:ring-white/50 focus:ring-offset-2 focus:ring-offset-forest sm:w-auto"
              >
                Solicitar tasación
                <ArrowRight
                  size={17}
      ...
      {isOpen && (
        ...
        >
          <div
            ...
            className="relative max-h-[94dvh] w-full overflow-y-auto rounded-t-2xl bg-surface text-ink shadow-2xl sm:max-h-[92vh] sm:max-w-2xl sm:rounded-2xl"
          >
            <div className="sticky top-0 z-10 flex items-start justify-between gap-4 border-b border-line bg-surface px-5 py-4 sm:px-8 sm:py-5">
            ...
            {!submitted ? (
                  ...
                  <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                    {['Vender', 'Alquilar'].map((option) => {
                      ...
                      return (
                        <label
                          key={option}
                          className={`flex min-h-12 cursor-pointer items-center justify-center rounded-lg border px-4 py-3 text-sm transition ${
                            selected
              ...
              <div className="flex min-h-95 flex-col items-center justify-center px-5 py-12 text-center sm:min-h-100 sm:px-8">
