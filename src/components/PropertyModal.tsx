      ...
      {property && (
        ...
        >
          <motion.div
            ...
            className="relative max-h-[94dvh] w-full max-w-4xl overflow-y-auto rounded-t-2xl bg-surface text-ink no-scrollbar shadow-2xl sm:max-h-[92vh] sm:rounded-2xl"
          >
            <button
              type="button"
              onClick={onClose}
            ...
            <div className="grid grid-cols-1 gap-8 p-5 sm:p-8 md:grid-cols-5">
                ...
                {property.operation === 'venta' && (
                  <div className="mt-8 rounded-xl border border-line p-5">
                    ...
                    <p className="mt-1 text-xs text-ink-soft">
                      Cálculo referencial a tasa fija del 6,5% anual. Sirve para
                      orientarse; no reemplaza un análisis crediticio formal.
                    </p>
